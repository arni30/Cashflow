...
formData.append('startTime', document.querySelector("#select_startTime").value);
formData.append('endTime', document.querySelector("#select_endTime").value);

let jsonString = formToJson(formData);
console.log(jsonString);

// let search = () => {
    angular.module("post_form", [])
